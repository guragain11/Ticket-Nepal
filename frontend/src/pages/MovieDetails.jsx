    ...
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      ...
      <div>
        ...
        <div className='flex justify-center mt-20'>
          <button onClick={()=> {navigate('/movies'); scrollTo(0,0)}} className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition-transform rounded-md font-medium cursor-pointer'>
            Show More
          </button>
